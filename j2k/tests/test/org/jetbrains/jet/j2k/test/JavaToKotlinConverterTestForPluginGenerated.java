...
public class JavaToKotlinConverterTestForPluginGenerated extends AbstractJavaToKotlinConveterTestForPlugin {
    ...
    public static class Formatting extends AbstractJavaToKotlinConveterTestForPlugin {
        public void testAllFilesPresentInFormatting() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.GenerateTests", new File("j2k/tests/testData/ast/formatting"), Pattern.compile("^(.+)\\.jav$"), true);
        }
